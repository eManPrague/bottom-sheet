...
import cz.eman.android.bottomsheet.utils.getStatusBarHeight
import cz.eman.android.bottomsheet.utils.getToolbarHeight
import kotlin.math.max
import kotlin.math.min

/**
 * @author Michal [michal.mrocek@eman.cz] on 13.07.17.
...
class SheetsHelper private constructor(private val sheetsHelperView: SheetsHelperView) {
     ...
     */
    fun initManually(view: View, behaviour: BottomSheet, collapsedHeight: Int, semiCollapsedHeight: Int, initialHeight: Int) {
    ...
    private fun onSheetSlide(bottomSheet: View, slideOffset: Float) {
        ...
        if (slideOffset >= 0.9) {
            sheetsHelperView.setStatusBarColor(evaluateStatusBarColor((slideOffset - 0.9).toFloat() * 10, nonExpanded, expanded))
     ...
     */
    private fun setMapPaddingAndTranslation(bottomSheet: View, collapsedHeight: Int, maxMapPadding: Int) {
    ...
    class Builder(private val context: Context, private val sheetView: SheetsHelperView) {
        ...
        init {
            val logoPaddingLeft = context.resources.getDimensionPixelSize(R.dimen.sheet_logo_additional_padding_left)
            val logoPaddingBottom = context.resources.getDimensionPixelSize(R.dimen.sheet_logo_additional_padding_bottom)
