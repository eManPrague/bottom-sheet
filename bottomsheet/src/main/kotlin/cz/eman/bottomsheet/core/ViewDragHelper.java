...
public class ViewDragHelper {
    ...
    public boolean smoothSlideViewTo(View child, int finalLeft, int finalTop) {
        return smoothSlideViewTo(child, finalLeft, finalTop, -1);
    }
     ...
     * @return true if animation should continue through {@link #continueSettling(boolean)} calls
     */
    public boolean smoothSlideViewTo(View child, int finalLeft, int finalTop, int minDuration) {
        mCapturedView = child;
        mActivePointerId = INVALID_POINTER;

        boolean continueSliding = forceSettleCapturedViewAt(finalLeft, finalTop, 0, 0, minDuration);
    ...
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel) {
        return forceSettleCapturedViewAt(finalLeft, finalTop, xvel, yvel, -1);
    }
     ...
     * @return true if animation should continue through {@link #continueSettling(boolean)} calls
     */
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel, int minDuration) {
        ...
        final int duration = Math.max(computeSettleDuration(mCapturedView, dx, dy, xvel, yvel), minDuration);
